...
class _MessagePassingScanState:
  ...
  stack: Optional[chex.Array]
  stack_pointers: Optional[chex.Array]
...
class Net(hk.Module):
  ...
  def _msg_passing_step(self,
    ...
    new_mp_state = _MessagePassingScanState(
        ...
        hiddens=hiddens,
        lstm_state=lstm_state, stack=stack, stack_pointers=stack_pointers)
  ...
  def __call__(self, features_list: List[_Features], repred: bool,
    ...
    for algorithm_index, features in zip(algorithm_indices, features_list):
      ...
      mp_state = _MessagePassingScanState(
          ...
          hiddens=hiddens, lstm_state=lstm_state, stack=stack, stack_pointers=stack_pointers)
